...
Takes a paired-end Illumina fastq file generated from an RNA-seq library, and that has been error corrected with rCorrector,and removes reads with errors but that are unfixable, and strips 'cor' flags from reads that were corrected.
